...
3) описание для ключевых слов title, keywords, description (от 150 до 250 символов, для разделения использовать запятую, сначала краткое описание и немного ключевых слов), в ключевых словах использовать слова: цена, доставка по России<br><br>
