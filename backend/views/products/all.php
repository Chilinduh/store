...
3) сделать отдельное описание для метатегов title, keywords, description (от 150 до 250 символов, не ставить точку в конце текстов, для разделения использовать запятую, сначала краткое описание и немного ключевых слов), в ключевых словах использовать слова: цена, доставка по России<br><br>
