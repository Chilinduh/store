      ...
      'columns' => [
        ...
        [
          ...
          'value' => static function ($model) {
            ...
            $html = '';
            $feedsItems = FeedsItems::find()->where(['feed_id' => $model->id])->all();
            ...
            $html .= 'Ссылка на фид для Яндекса: '. Yii::$app->params['siteUrl']. '/feeds/'.$model->id.'<br>';
            return $html;
          }
        ],
        [
          ...
          'buttons' => [
            'update' => function ($url, $model) {
              ...
              return '<a href="/feeds/' . $model->id . '" class="menu-link px-3">
