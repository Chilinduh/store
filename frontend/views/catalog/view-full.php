  ...
  <div class="container">
                ...
                <div class="product__info-body">
                  ...
                  <div class="product__prices-stock">
                    ...
                    <div class="status-badge status-badge--style--success product__stock status-badge--has-text">
                      <div class="status-badge__body" style="background-color:<?= $product['availability_color']??'' ?>">
                        <div class="status-badge__text" style="color:#fff"><?= $product['availability'] ?></div>
	...
	c0.4,0,0.8-0.3,0.8-0.8s-0.3-0.8-0.8-0.8h-2.5v-1.7H28c0.4,0,0.8-0.3,0.8-0.8s-0.3-0.8-0.8-0.8h-0.9v-1.7L29.6,21.9L29.6,21.9z"></path>
                    ...
                    <div class="shop-features__info">
                      <div class="shop-features__item-title">Доставка по России</div>
                      <div class="shop-features__item-subtitle">В любой регион</div>
                    </div>
                  </li>
	...
	S40.1,35.1,40.3,35.1z"></path>
                    ...
                    <div class="shop-features__info">
                      <div class="shop-features__item-title">Цены на сайте</div>
                      <div class="shop-features__item-subtitle">Представлены за наличный расчёт</div>
                    </div>
                  </li>
                  <li class="shop-features__divider" role="presentation"></li>
                  <li class="shop-features__item">
	...
	s0.4-0.1,0.5-0.2l1.8-1.8l5.3,5.3c0.2,0.2,0.4,0.2,0.5,0.2c0.2,0,0.4-0.1,0.5-0.2c0.3-0.3,0.3-0.8,0-1.1L27.4,15.8z"></path>
                    ...
                    <div class="shop-features__info">
                      ...
                      <div class="shop-features__item-subtitle">Скидки до 30%</div>
                    </div>
                  </li>
                  <li class="shop-features__divider" role="presentation"></li>
                </ul>
        ...
        <div class="block block-products-carousel" data-layout="grid-5">
          <div class="container">
            ...
            <?= $this->context->renderPartial('/site/_carousel', ['products' => $productsRelated]); ?>
          </div>
        </div>
