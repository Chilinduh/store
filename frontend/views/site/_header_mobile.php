      ...
      <div class="mobile-header__body">
        ...
        <div class="mobile-header__indicators">
          <div class="mobile-socials">
            <?php if(Yii::$app->params['socials']['telegramm']??false) { ?>
              <a href="<?= Yii::$app->params['socials']['telegramm'] ?? '' ?>" class="telegramm" target="_blank">
              ...
              <?php } ?>
              <?php if(Yii::$app->params['socials']['max']??false) { ?>
              <a href="<?= Yii::$app->params['socials']['max'] ?? '' ?>" class="max" target="_blank">
