...
<div class="products-list__item">
  <div class="product-card">
    ...
    <div class="product-card__image">
      ...
      <div class="status-badge status-badge--style--success product-card__fit status-badge--has-text">
    ...
    <div class="product-card__footer">
      ...
      <button class="product-card__addtocart-icon <?= isset($product['inCart']) && !$product['inCart'] ? 'cart-add' : 'cart-open' ?>"
              type="button"
              data-icon="icon"
              data-id="<?= $product['id'] ?>"
              aria-label="В корзину">
            <i class="fa-solid fa-cart-plus <?= isset($product['inCart']) && $product['inCart'] ? 'in-cart' : '' ?>" aria-hidden="true"></i>
      </button>
      <button
